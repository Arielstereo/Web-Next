...
export default function Home() {
  return (
    <header className="relative">
      ...
      <div className="absolute inset-0 mt-48 md:ml-32 bg-yellow-300 w-[340px] md:w-[600px] h-fit p-8 rounded-r-2xl flex flex-col">
        ...
        <div className="flex flex-col gap-12 md:gap-32">
          ...
          <div class="flex flex-col gap-8">
            ...
            >
              <defs>
                <linearGradient
                  id="IconifyId18f07292754d8c31c0"
                  x1="50%"
                  x2="50%"
                  y1="100%"
                  y2="0%"
                ...
                <linearGradient
                  id="IconifyId18f07292754d8c31c1"
                  x1="50%"
                  x2="50%"
                  y1="100%"
                  y2="0%"
              ...
              <path
                fill="url(#IconifyId18f07292754d8c31c0)"
                d="M5.463 127.456c-.006 21.677 5.658 42.843 16.428 61.499L4.433 252.697l65.232-17.104a122.994 122.994 0 0 0 58.8 14.97h.054c67.815 0 123.018-55.183 123.047-123.01c.013-32.867-12.775-63.773-36.009-87.025c-23.23-23.25-54.125-36.061-87.043-36.076c-67.823 0-123.022 55.18-123.05 123.004"
              />
              <path
                fill="url(#IconifyId18f07292754d8c31c1)"
              ...
              >
                <g fill="none">
                  <rect
                    width="256"
                    height="256"
                    fill="url(#IconifyId18eed20b23f63300f0)"
                    rx="60"
                  />
                  <rect
                    width="256"
                    height="256"
                    fill="url(#IconifyId18eed20b23f63300f1)"
                    rx="60"
                  />
                  <path
                    fill="#fff"
                  ...
                  <defs>
                    <radialGradient
                      id="IconifyId18eed20b23f63300f0"
                      cx="0"
                      cy="0"
                      r="1"
                    ...
                    <radialGradient
                      id="IconifyId18eed20b23f63300f1"
                      cx="0"
                      cy="0"
                      r="1"
